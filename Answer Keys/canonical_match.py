...
_MLB_TEAMS = {
    ...
    "Chicago Cubs": ["CHC", "CUBS", "CHI CUBS", "CHICAGO CUBS", "CHICAGO C"],
    "Chicago White Sox": ["CWS", "WHITE SOX", "CHI WHITE SOX", "CHICAGO WHITE SOX", "CHICAGO WS"],
    ...
    "Los Angeles Angels": ["LAA", "ANGELS", "LA ANGELS", "ANAHEIM", "LOS ANGELES A"],
    "Los Angeles Dodgers": ["LAD", "DODGERS", "LA DODGERS", "LOS ANGELES DODGERS", "LOS ANGELES D"],
    ...
    "New York Mets": ["NYM", "METS", "NY METS", "NEW YORK METS", "NEW YORK M"],
    "New York Yankees": ["NYY", "YANKEES", "NY YANKEES", "NEW YORK YANKEES", "NEW YORK Y"],
    "Athletics": ["OAK", "ATHLETICS", "OAK ATHLETICS", "OAKLAND", "OAKLAND ATHLETICS", "A'S", "AS"],
