# CBB Derivative Backtest - Parameter Sweep
# Tests different sample sizes and EV thresholds
# Structured for future extraction to Tools.R
...
cat("===========================================\n")
cat("CBB PARAMETER SWEEP\n")
cat("===========================================\n\n")
cat("Test games:", N_TEST_GAMES, "\n")
...
saveRDS(full_results, "CBB Answer Key/parameter_sweep_full_predictions.rds")
write.csv(summary_table, "CBB Answer Key/parameter_sweep_full_summary.csv", row.names = FALSE)

cat("\n===========================================\n")
cat("SWEEP COMPLETE\n")
cat("===========================================\n")
cat("Full predictions saved to: parameter_sweep_predictions.rds\n")
cat("Summary table saved to: parameter_sweep_summary.csv\n")
