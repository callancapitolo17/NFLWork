...
(function (root) {
  ...
  const api = {
    ...
    bannerLines, badges, relatedLines, stakeAdvice, capAtLiquidity, suggestedBetAmount, stakeAdviceWords, stakeAdviceLine, venuesWithFreshPull, mergeServicePayload, mergePageSource, crosswalkOf, crosswalkRows, ticketAsLine, sanitizeBetsSettings,
  };
